<%@ page import="static java.lang.Integer.parseInt" %><%--@page contentType="text/html" pageEncoding="UTF-8"--%>
<%
    ...
    if(cookies!=null)
    {
        ...
        {
            if(cookies[i].getName().equals("c_user_status"))
            {
                session.setAttribute("user_id", Integer.parseInt(cookies[i].getValue()));
            }
